...
let camps = [];
const formId = '64dc6efdd03d703c5e8b9d01'
const mock = {
...
const batchRunner = async ({ batch, batchIndex }) => {
  ...
  for (const item of batch) {
    ...
    for (const formsDetails of data.formsDetails) {
      ...
      formsDetails.results.left_freq_500 = String(_.random(34, 38));
      formsDetails.results.left_freq_1000 = String(_.random(38, 44));

      formsDetails.results.left_freq_2000 = String(_.random(44, 48));
      formsDetails.results.left_freq_4000 = String(_.random(45, 52));
      formsDetails.results.right_freq_500 = String(_.random(32, 38));
      formsDetails.results.right_freq_1000 = String(_.random(38, 44));
      formsDetails.results.right_freq_2000 = String(_.random(44, 48));
      formsDetails.results.right_freq_4000 = String(_.random(45, 52));
