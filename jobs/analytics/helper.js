...
exports.screeningForUpdate = ({ group }) => {
  ...
  const update = {
    ...
    ...(optometry.status === "Done" && {
      ...
      "LE Cylindrical": optometry?.screeningData?.LE_Cylindrical,
      "RE Axis": optometry?.screeningData?.RE_Axis,
      "LE Axis": optometry?.screeningData?.LE_Axis,
      "Re Addition": optometry?.screeningData?.Re_Addition,
      "LE Addition": optometry?.screeningData?.LE_Addition,
      "Optometry Comment": optometry?.screeningData?.Comment,
    }),
